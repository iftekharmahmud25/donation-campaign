...
const DonationsCard = ({ donation, searchCategory }) => {
  const {
    id,
    category,
    title,
  ...
  // Check if searchCategory is not empty and if it matches the card's category
  const shouldDisplayCard = !searchCategory || category === searchCategory;
      ...
      {shouldDisplayCard && (
        <Link to={`/donation/${id}`}>
          <div style={cardStyle} className="card h-96  bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              <button style={btnbgcolor} className='text-center w-[90px] rounded-md '>
